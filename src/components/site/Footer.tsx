            ...
            <ul className="mt-6 space-y-6 text-sm text-primary-foreground/70">
              {[company.registeredOffice, company.factory].map((place) => (
                <li key={place.label} className="flex gap-3">
                  <MapPin className="mt-0.5 size-4 shrink-0 text-blue-muted" aria-hidden="true" />
                  <span>
              ...
              <li className="flex gap-3">
                <Phone className="mt-0.5 size-4 shrink-0 text-blue-muted" aria-hidden="true" />
                <a
              ...
              <li className="flex gap-3">
                <Mail className="mt-0.5 size-4 shrink-0 text-blue-muted" aria-hidden="true" />
                <a
