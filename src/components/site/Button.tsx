...
const variants: Record<Variant, string> = {
  primary: "bg-navy text-primary-foreground hover:bg-slate-blue shadow-soft hover:-translate-y-0.5",
  outline: "border border-navy/20 text-navy hover:border-navy/60 hover:bg-secondary",
  light: "bg-background text-navy hover:bg-pink-soft/70 shadow-soft hover:-translate-y-0.5",
  ghost:
