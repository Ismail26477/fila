  ...
  if (status === "success") {
    return (
      <div className="rounded-2xl border border-border bg-card p-10 text-center shadow-soft">
        <CheckCircle2 className="mx-auto size-10 text-plum" aria-hidden="true" />
        <h3 className="mt-5 font-display text-xl font-bold text-navy">Enquiry sent</h3>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        {fields.map((field) => (
          ...
          >
            <label
              htmlFor={field.name}
              className="mb-2 block text-xs font-semibold tracking-[0.14em] text-slate-blue uppercase"
            >
              {field.label}
            ...
            <input
              ...
              className={cn(
                "w-full rounded-md border bg-background px-4 py-3 text-sm text-navy transition-colors placeholder:text-muted-foreground/70 focus:border-blue-muted focus:outline-none",
        ...
        <div className="sm:col-span-2">
          ...
          <textarea
            ...
            className={cn(
              "w-full resize-y rounded-md border bg-background px-4 py-3 text-sm text-navy transition-colors focus:border-blue-muted focus:outline-none",
