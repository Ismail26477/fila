    ...
    <section className="section-y bg-surface">
      <div className="container-x">
        <Reveal className="max-w-2xl">
          ...
          <h2 className="mt-5 text-2xl leading-tight font-extrabold text-navy sm:text-4xl">
        ...
        <ul className="mt-10 flex snap-x snap-mandatory gap-5 overflow-x-auto pb-4 [scrollbar-width:none] lg:mt-14 lg:grid lg:grid-cols-3 lg:overflow-visible xl:grid-cols-4">
          {testimonials.map((item, i) => (
            ...
            >
              <Quote className="size-7 text-plum" aria-hidden="true" />
              ...
              <p className="mt-5 text-sm leading-relaxed text-slate-blue">{item.quote}</p>
