...
function ProductDetail() {
  ...
  return (
    <>
      <section className="relative overflow-hidden bg-navy-deep pt-32 pb-16 text-primary-foreground md:pt-40 md:pb-24">
      ...
      <section className="section-y bg-background">
        <div className="container-x grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          ...
          <Reveal delay={0.1} className="space-y-5 text-base leading-relaxed text-slate-blue">
            <p>
            ...
            <p>
              ...
              write to{" "}
              <a href={`mailto:${company.email}`} className="font-semibold break-all text-navy">
                {company.email}
              </a>
              .
            </p>
      ...
      {related.length > 0 && (
        <section className="section-y bg-surface">
          <div className="container-x">
            <Reveal>
              <h2 className="text-2xl font-extrabold text-navy sm:text-3xl">Other products</h2>
            </Reveal>
