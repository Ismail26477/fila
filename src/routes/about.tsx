...
function About() {
  return (
    <>
          ...
          <div>
            ...
            <Reveal delay={0.1}>
              ...
              <dl className="mt-10 grid gap-6 border-t border-border pt-8 sm:grid-cols-2">
                <div>
                  <dt className="text-xs font-semibold tracking-[0.2em] text-slate-blue uppercase">
                    Corporate Identity Number
                  </dt>
                  <dd className="mt-2 font-display text-lg font-bold text-navy">{company.cin}</dd>
                </div>
                <div>
                  <dt className="text-xs font-semibold tracking-[0.2em] text-slate-blue uppercase">
                    Email
                  ...
                  <dd className="mt-2">
                    <a
                      ...
                      className="font-display text-lg font-bold break-all text-navy hover:text-slate-blue"
                    >
                      {company.email}
                    </a>
                  </dd>
      ...
      <section className="section-y bg-surface">
        <div className="container-x">
          ...
          <div className="mt-10 grid gap-6 lg:grid-cols-2">
            <Reveal className="relative overflow-hidden rounded-3xl bg-navy p-9 text-primary-foreground md:p-14">
            ...
            >
              <div className="relative">
                ...
                <p className="mt-6 text-base leading-relaxed text-navy">
                ...
                <p className="mt-5 text-base leading-relaxed text-slate-blue">
      ...
      {/* Presence */}
      <section className="section-y relative overflow-hidden bg-navy-deep text-primary-foreground">
