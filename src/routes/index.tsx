        ...
        <div className="container-x relative grid items-center gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:gap-20">
          <Reveal className="relative">
            ...
            >
              ...
              <p className="mt-2 font-display text-2xl font-bold text-navy">Maharashtra, India</p>
          ...
          <div>
            <Reveal>
              ...
              <h2 className="mt-6 text-3xl leading-tight font-extrabold text-navy sm:text-4xl lg:text-[2.75rem]">
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <Reveal>
              <p className="eyebrow-light">
                <span className="h-px w-8 bg-blue-muted" aria-hidden="true" />
          ...
          <ul className="mt-14 grid gap-5 sm:grid-cols-2 xl:grid-cols-4">
            {pillars.map((pillar, i) => (
              <Reveal
                ...
                key={pillar.title}
                delay={i * 0.08}
                className="group relative overflow-hidden rounded-2xl border border-primary-foreground/15 bg-navy-deep p-7 transition-all duration-500 hover:-translate-y-1.5 hover:border-blue-muted/60"
              >
                <span
                ...
                />
                <pillar.icon
                  className="relative size-7 text-blue-muted transition-transform duration-500 group-hover:-translate-y-0.5 group-hover:scale-110"
                  aria-hidden="true"
                />
        ...
        <div className="container-x">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-base text-slate-blue">
                ...
                <Reveal as="li" key={service.no} delay={i * 0.06} className="group py-7">
                  <div className="flex gap-6">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-2 text-sm leading-relaxed text-slate-blue">{service.text}</p>
                    </div>
                  </div>
                </Reveal>
              ))}
