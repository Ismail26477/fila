    ...
    <>
      ...
      <section className="section-y bg-background">
        <div className="container-x grid gap-14 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          <Reveal>
            <p className="eyebrow">
              <span className="h-px w-8 bg-plum" aria-hidden="true" />
              Connect With Us
            </p>
            <h2 className="mt-6 text-2xl leading-tight font-extrabold text-navy sm:text-3xl">
              {company.name}
            </h2>
            ...
            <div className="mt-9 space-y-8 text-sm">
              {[company.registeredOffice, company.factory].map((place) => (
                <div key={place.label}>
                  <h3 className="text-xs font-semibold tracking-[0.2em] text-slate-blue uppercase">
                    {place.label}
                  </h3>
                  <address className="mt-2 leading-relaxed text-navy not-italic">
                  ...
                  <a
                    ...
                    className="mt-2 inline-block text-xs font-semibold text-plum hover:opacity-75"
                  >
                    Open in Google Maps
                  </a>
                </div>
              ...
              <div>
                ...
                <a
                  ...
                  className="mt-2 inline-flex items-center gap-2 font-medium break-all text-navy hover:text-slate-blue"
                >
                  <Mail className="size-4 shrink-0 text-plum" aria-hidden="true" />
                  {company.email}
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  ...
                  className="mt-2 inline-flex items-center gap-2 font-medium text-navy hover:text-slate-blue"
                >
                  <Phone className="size-4 shrink-0 text-plum" aria-hidden="true" />
                  +91 {company.phone}
                </a>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-navy">{company.foundedYear}</p>
              </div>
              ...
              <div>
                ...
                <p className="mt-2 text-navy">{company.cin}</p>
              </div>
            </div>
          </Reveal>
          ...
          <Reveal className="overflow-hidden rounded-3xl border border-border bg-surface shadow-soft">
            {embedSrc ? (
              ...
              <div className="flex flex-col items-start gap-4 p-9 md:p-12">
                ...
                <p className="max-w-xl text-base leading-relaxed text-slate-blue">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center rounded-md bg-navy px-6 py-3 text-sm font-semibold text-primary-foreground transition-colors hover:bg-slate-blue"
                >
                  Open in Google Maps
                </a>
              </div>
