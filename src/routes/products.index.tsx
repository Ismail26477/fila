            ...
            <div className="flex w-full flex-col gap-4 sm:flex-row sm:items-center lg:w-auto">
              <div className="relative w-full sm:w-72">
                ...
                <input
                  ...
                  className="w-full rounded-md border border-input bg-background py-3 pr-4 pl-10 text-sm text-navy focus:border-blue-muted focus:outline-none"
                />
              </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      category === item
                        ...
                        : "border-input text-slate-blue hover:border-navy/40",
                    )}
                  >
                    {item}
                  </button>
