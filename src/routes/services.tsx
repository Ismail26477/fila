          ...
          >
            <div className="container-x">
              ...
              >
                ...
                <Reveal delay={0.1}>
                  <p className="font-display text-5xl font-extrabold text-pink-soft sm:text-6xl">
                    {service.no}
                  </p>
                  <h2 className="mt-5 text-2xl leading-tight font-extrabold text-navy sm:text-3xl lg:text-4xl">
                    {service.title}
                  </h2>
                  <p className="mt-5 text-base leading-relaxed text-slate-blue">{service.text}</p>
                  <ul className="mt-8 space-y-3 border-t border-border pt-7">
                    {service.points.map((point) => (
                      <li key={point} className="flex gap-3 text-sm text-slate-blue">
                        <span
                          className="mt-2 size-1.5 shrink-0 rounded-full bg-plum"
                          aria-hidden="true"
                        />
                        {point}
                      </li>
        ...
        <div className="container-x rounded-3xl border border-border bg-card p-9 shadow-soft md:p-12">
          <Reveal className="grid gap-6 md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
            <div className="min-w-0">
              ...
              <p className="mt-3 max-w-xl text-sm leading-relaxed text-slate-blue">
